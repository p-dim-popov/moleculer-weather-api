// To parse this data:
//
//   import { Convert, LocationInfo } from "./file";
//
//   const locationInfo = Convert.toLocationInfo(json);
//
...
export class Convert {
    public static toLocationInfo(json: string): LocationInfo {
        return cast(JSON.parse(json), r("LocationInfo"));
    }

    public static locationInfoToJson(value: LocationInfo): string {
        return JSON.stringify(uncast(value, r("LocationInfo")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    Main: o(
        [
            ...
            { json: "feels_like", js: "feelsLike", typ: 3.14 },
            { json: "temp_min", js: "tempMin", typ: 3.14 },
            { json: "temp_max", js: "tempMax", typ: 3.14 },
